...
const classes = {
  ...
  imageContainer:
    "border-solid rounded-full mb-2 row-span-2 border-4 md:border-4 border-gray-200 md:mr-20 order-1 w-32 h-32 justify-self-center md:w-64 md:h-64 md:col-span-1 md:self-center md:justify-self-end md:order-2 md:mb-0 dark:border-gray-800",
};
